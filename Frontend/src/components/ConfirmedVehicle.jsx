...
function ConfirmedVehicle(
  { image = "", setconfirmedvehiclepanel, setvehicleFound, createRide, fare, pickup, destination, vehicleType }
) {
  return (
    <div>
      ...
      <div className='flex gap-2 justify-between items-center flex-col'>
        ...
        <div className="details w-full flex flex-col gap-8 mt-4 lg:h-1/2">
          ...
          <div
            ...
            <div>
              <p className='text-lg text-zinc-600 -mt-1'>{pickup}</p>
            </div>
          </div>
          ...
          <div
            ...
            <div>
              <p className='text-lg text-zinc-600 -mt-1'>{destination}</p>
            </div>
          </div>
          <div
